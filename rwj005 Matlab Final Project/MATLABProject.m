...
%Loop for dice roll method of choosing variables 
for count_category = 1:n
 
c1 = randi(4);
house = ["Mansion", "Apartment", "Shack", "House"];
%If clauses for adding to the variables 
if c1 == 1;
...
%Job Loop, repeat steps for new list
...
%Results list for the chosen future
