...
if c1_results(1,1) == c1_results(1,2);
    c1_results(1,1) = c1_results(1,1) + 1;
 
elseif c1_results(1,1) == c1_results(1,3);
    c1_results(1,1) = c1_results(1,1) + 1;
 
elseif c1_results(1,1) == c1_results(1,4);
    c1_results(1,1) = c1_results(1,1) + 1;
 
elseif c1_results(1,2) == c1_results(1,3);
    c1_results(1,2)  = c1_results(1,2) + 1;
 
elseif c1_results(1,2) == c1_results(1,4);
    c1_results(1,2)  = c1_results(1,2) + 1;
 
elseif c1_results(1,3) == c1_results(1,4);
    c1_results(1,3) = c1_results(1,3) + 1;
end   
